...
const QuizInterativo: React.FC<Props> = ({
  pergunta,
  alternativas,
  correta,
  onAcerto,
    ...
    <div className="card p-6">
      ...
      <div className="grid grid-cols-1 gap-3 mb-4">
        {alternativas.map((a) => {
          ...
          let cls =
            "px-4 py-3 text-left rounded border transition-colors duration-150 focus:outline-none";
          if (status === "idle") {
            if (sel === a.key) cls += " bg-blue-600 text-white border-blue-700";
            else
              cls +=
                " bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700";
          } else {
            ...
            if (a.key === correta) {
              ...
              cls +=
                " bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-gray-200 dark:border-gray-700 opacity-90";
            }
          }
          return (
            <button
      ...
      {status !== "idle" && explicacao && (
        <div
          className={`mt-4 p-4 rounded shadow-sm border-l-4 ${
            status === "ok"
