        ...
        <div className="card p-6">
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3">
                <label htmlFor="perfilUpload" className="btn-upload">
                  Carregar foto
                </label>
                <input
                  id="perfilUpload"
          ...
          <div>
            ...
            <div className="flex gap-3">
              {badges.map((b) => (
                <div
                  key={b.name}
                  className="px-3 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 border border-gray-200 dark:border-gray-700"
                >
        ...
        <div className="mt-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-4 dark:bg-gray-700">
            <div
              ...
              style={{ width: `${xpAtual % 100}%` }}
            ></div>
          </div>
          <div className="text-sm text-gray-600 dark:text-gray-300 mt-1">
            Faltam {faltante} XP para o próximo nível.
          </div>
        </div>
      </div>
    </div>
